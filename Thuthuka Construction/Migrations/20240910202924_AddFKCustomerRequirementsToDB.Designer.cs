...
namespace Thuthuka_Construction.Migrations
{
    ...
    [Migration("20240910202924_AddFKCustomerRequirementsToDB")]
    partial class AddFKCustomerRequirementsToDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Thuthuka_Construction.Models.Project", b =>
                {
                    ...
                    b.HasOne("Thuthuka_Construction.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
